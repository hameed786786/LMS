      ...
      <div className="mx-auto max-w-[1440px] w-full px-6 md:px-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
          <div className="flex flex-col items-start gap-4">
            ...
            <h2 className="font-inter font-normal text-[48px] leading-[1.15] tracking-[-0.03em] text-[#000000] max-w-[640px]">
              Experience every product before you buy
            </h2>
            ...
            <div className="flex flex-wrap gap-2.5 mt-4">
              {(["super-admin", "tutor", "learner", "marketplace"] as ProductTab[]).map((tab) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-[12px] font-inter text-[14px] font-semibold border transition-all duration-200 ${
                    activeProduct === tab
          ...
          <div className="max-w-[540px] lg:pt-12">
            <p className="font-inter font-normal text-[19px] leading-[1.7] text-neutral-500">
              Explore guided interactive demos of each platform before booking a consultation.
            </p>
          </div>
        </div>
        ...
        <div className="relative mx-auto mt-[44px] w-297 max-lg:w-full max-lg:px-2">
          ...
          {/* ================= GLOW WRAPPER ================= */}
          <div className="relative h-190 overflow-hidden rounded-[94px] max-lg:h-[420px] max-md:h-[420px] max-lg:rounded-[34px] isolate">
          ...
          >
            ...
            >
              <button
                ...
                className={`flex h-[26px] min-w-[82px] items-center justify-center rounded-full px-5 text-[11px] font-bold transition-all duration-200 ${
                  mediaType === "video"
          ...
          <div className="absolute -bottom-6 left-1/2 z-20 flex -translate-x-1/2 items-center gap-8 max-lg:hidden">
            <button
              onClick={() => setMediaType("video")}
              className={`flex h-12 w-45.25 items-center justify-center rounded-full font-inter text-[16px] font-semibold transition-all duration-200 ${
                mediaType === "video"
            ...
            <button
              onClick={() => setMediaType("demo")}
              className={`flex items-center justify-center text-center font-inter text-[16px] font-semibold hover:text-black/85 transition-all gap-1.5 group ${
                mediaType === "demo"
                  ? "text-black"
                  : "text-neutral-500"
              }`}
